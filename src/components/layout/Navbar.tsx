...
import { TrendingUp, Menu, X, ChevronRight, Bell, User } from 'lucide-react';
        ...
        <div style={{ maxWidth:'1280px', margin:'0 auto', padding:'0 24px', display:'flex', alignItems:'center', justifyContent:'space-between', height:'72px' }}>
          ...
          <Link to="/" style={{ display:'flex', alignItems:'center', gap:'10px', textDecoration:'none' }}>
            <div style={{
              ...
              <TrendingUp size={20} color="#0A0A0A" strokeWidth={2.5} />
            </div>
            <span style={{ fontSize:'20px', fontWeight:700, letterSpacing:'-0.3px' }}>
              <span style={{ color:'#C9A050' }}>JTC</span>
              <span style={{ color:'#fff', marginLeft:'4px' }}>Invest</span>
            </span>
          </Link>
