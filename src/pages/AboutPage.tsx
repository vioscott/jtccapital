        ...
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div style={{
              ...
              <span style={{ color: '#C9A050', fontSize: '13px', fontWeight: 500 }}>About JTC Capital Management</span>
            </div>
            ...
            <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.55)', lineHeight: 1.75 }}>
              JTC Capital Management is a next-generation investment platform dedicated to making gold and crypto markets accessible, transparent, and secure for every investor.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section style={{ padding: '60px 24px 80px', background: '#0D0D0D' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.5)', lineHeight: 1.85, fontSize: '15px' }}>
            ...
            When you invest with JTC Capital Management, you invest with a team that treats your capital with the same respect as their own.
          </p>
        </div>
      </section>
    </div>
