...
const testimonials = [
  { name: 'Marcus T.', role: 'Private Investor', text: 'JTC Capital Management gave me exposure to gold I never thought possible. Returns have been solid and the interface is beautiful.', stars: 5 },
        ...
        <div className="r-grid-hero" style={{ maxWidth: '1280px', margin: '0 auto', width: '100%' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 style={{
              ...
              Invest in{' '}
              <span className="gradient-text-gold text-glow-gold">Crypto Assets</span>
              <br />with Confidence
            </h1>
